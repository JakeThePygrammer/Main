...
SELECT * from Kurs where krediti < 3 AND krediti > 0;
SELECT * from Kurs where krediti < 6 AND krediti > 4 and profesorid ='2';
SELECT * from Kurs where krediti < 6 AND krediti > 4 and profesorid ='2';
SELECT * from Kurs where krediti < 6 AND krediti > 0;
SELECT * from Kurs where krediti > 6 and profesorid ='1';